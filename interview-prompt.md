...
**Provenance block** (fixed, near the end): generating model + vendor, timestamp, `pack_version`, fetch URL and date, integrity check result, mode, product files actually loaded, skill / prompt version `interview-prompt-2026-08-18.5`, the tiers they granted and refused, matrix status line, and:
